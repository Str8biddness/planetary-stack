...
class LLMBridge:
    ...
    async def generate(self, prompt: str, system_prompt: str = "You are Synthesus, a local, private synthetic intelligence. Your name is Synthesus.") -> str:
